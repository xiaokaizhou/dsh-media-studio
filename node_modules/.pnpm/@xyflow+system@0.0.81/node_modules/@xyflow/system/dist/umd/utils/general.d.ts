...
export declare const getRectsOverlappingArea: (aX: number, aY: number, aWidth: number, aHeight: number, bX: number, bY: number, bWidth: number, bHeight: number) => number;
...
export declare const createDevWarn: (lib: string, helpUrl: string) => (id: string, message: string) => void;
...
export declare function isDomNodeVisible(selector: string): boolean;
