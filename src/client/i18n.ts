...
const DICT = {
  zh: {
    ...
    'view.clear': '清空画布',
    'region.arrange': '整理区域内节点',
    'view.arrangeMode': '选择排列方式',
    'view.arrange.flow': '拓扑排列',
    'view.arrange.flowDesc': '按节点上下游深度分列，不动现有分区',
    'view.arrange.region': '拓扑 + 区域',
    'view.arrange.regionDesc': '拓扑排列每个分区内部的节点并贴合分区',
    'view.arrange.smart': 'AI 智能',
    'view.arrange.smartDesc': '按主题自动建分区并合理排列所有节点',
  ...
  en: {
    ...
    'region.arrange': 'Arrange nodes in region',
    'view.arrangeMode': 'Pick an arrangement mode',
    'view.arrange.flow': 'Flow',
    'view.arrange.flowDesc': 'Columns by upstream depth, regions untouched',
    'view.arrange.region': 'Flow + regions',
    'view.arrange.regionDesc': 'Tidy each region’s nodes and snap boxes to fit',
    'view.arrange.smart': 'AI smart',
    'view.arrange.smartDesc': 'Auto-create regions by topic and tidy everything',
